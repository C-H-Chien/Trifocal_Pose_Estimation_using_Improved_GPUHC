...
//> Dataset
#define USE_SYNTHETIC_CURVE_DATASET               (true)
//> If USE_SYNTHETIC_CURVE_DATASET == false
#define TARGET_PARAMS_SOURCE_DATASET              std::string("/oscar/data/bkimia/cchien3/CupDataset/")
//> If USE_SYNTHETIC_CURVE_DATASET == true
...
#define RANSAC_Number_Of_Iterations               (100)
...
#define MULTIPLES_OF_BATCHCOUNT                   (100)
#define MULTIPLES_OF_TRACKING_PER_WARP            (1)

//> Noise applied to synthetic data for both points and tangents
#define NOISE_DISTRIBUTION_STD_INLIERS_POINTS     (0.0)     //> in pixel
#define NOISE_DISTRIBUTION_STD_OUTLIERS_POINTS    (150)
#define NOISE_DISTRIBUTION_STD_INLIERS_TANGENTS   (0.0)     //> in degree
...
//> Some TESTINGS
#define TOTAL_TEST_TIMES                        (1)   //> TEST: repeated times, simulating how many relative pose estimation needs to be computed
...
#define DEBUG                      (0)
#define TRIPLET_MATCHES_DEBUG      (1)
