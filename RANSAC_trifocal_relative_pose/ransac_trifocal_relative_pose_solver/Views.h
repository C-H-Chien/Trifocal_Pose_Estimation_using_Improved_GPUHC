...
namespace magmaHCWrapper {
    ...
    struct View1 {
        std::vector<Eigen::Vector2d> img_points;            //> All 2d image points on curves
        std::vector<Eigen::Vector2d> img_tangents;          //> All 2d image tangents on curves
        std::vector<Eigen::Vector2d> img_perturbed_points;            //> All 2d perturbed image points on curves
        std::vector<Eigen::Vector2d> img_perturbed_tangents;          //> All 2d perturbed image tangents on curves
    ...
    struct View2 {
        ...
        std::vector<Eigen::Vector2d> img_tangents;
        std::vector<Eigen::Vector2d> img_perturbed_points;
        std::vector<Eigen::Vector2d> img_perturbed_tangents;
        Eigen::Matrix3d abs_R;
        Eigen::Vector3d abs_C;
        Eigen::Vector3d abs_T;
    };
    ...
    public:
        ...
        void Add_Noise_to_Points_on_Curves(float outlier_ratio);
